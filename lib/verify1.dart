...
class VirifyOne extends StatefulWidget {
  const VirifyOne({super.key});

  @override
  State<VirifyOne> createState() => _VirifyOneState();
}

class _VirifyOneState extends State<VirifyOne> 
{
  @override
